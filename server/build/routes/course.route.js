...
courseRouter.put("/enroll-course/:id", auth_1.isAuthenticated, course_controller_1.enrollInCourse);
...
courseRouter.get("/get-admin-courses", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.getAdminCourses);
courseRouter.get("/get-playback-id", course_controller_1.getPlaybackId);
courseRouter.delete("/delete-course", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.deleteCourse);
