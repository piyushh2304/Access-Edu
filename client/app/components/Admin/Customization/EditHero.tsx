...
const EditHero: FC<Props> = (props: Props) => {
  ...
  const bannerImageRef = useSpeechOnHover<HTMLImageElement>("Hero banner image");
  const changeImageRef = useSpeechOnHover<HTMLLabelElement>("Change banner image");
  const titleTextareaRef = useSpeechOnHover<HTMLTextAreaElement>("Hero title input field");
  const subTitleTextareaRef = useSpeechOnHover<HTMLTextAreaElement>("Hero subtitle input field");
  const saveButtonRef = useSpeechOnHover<HTMLDivElement>("Save hero changes");
      ...
      <div className="1000px:w-[40%] flex 1000px:min-h-screen items-center justify-end pt-[70px] 1000px:pt-[0] z-10">
        <div className="relative flex items-center justify-end">
          ...
          <input
            ...
            className="hidden"
          />
          <label ref={changeImageRef} tabIndex={0} htmlFor="banner" className="absolute bottom-0 right-0 z-20">
